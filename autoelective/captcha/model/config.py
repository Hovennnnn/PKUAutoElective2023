...
import yaml
import threading
from autoelective.captcha.model.category import *
from autoelective.captcha.model.constants import *
from autoelective.captcha.model.exception import exception, ConfigException
...
class ModelConfig:
    ...
    def __init__(self, project_name, project_path=None, is_dev=True, **argv):
        self.is_dev = is_dev
        self.project_path = project_path if project_path else os.path.join(os.path.dirname(__file__), "projects", project_name)
