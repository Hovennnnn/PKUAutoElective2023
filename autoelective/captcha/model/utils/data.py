...
import numpy as np
from autoelective.captcha.model.constants import RunMode, ModelField, DatasetType, LossFunction
from autoelective.captcha.model.config import ModelConfig, EXCEPT_FORMAT_MAP
from autoelective.captcha.model.encoder import Encoder
from autoelective.captcha.model.exception import exception
        ...
        for index, (i1, i2) in enumerate(zip(_input, _label)):
            try:
                ...
                if isinstance(label_array, dict):
                    # tf.compat.v1.logging.warn("The sample label {} contains invalid charset: {}.".format(
